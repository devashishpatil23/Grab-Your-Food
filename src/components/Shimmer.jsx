    ...
    <div className="container mx-auto">
      <div className="py-3 my-3">
        <form className="flex items-center max-w-64 lg:max-w-sm mx-auto">
          ...
          <button
            type="submit"
            className="px-2.5 py-2 w-20 ml-2 text-sm font-medium text-white flex items-center bg-gray-300 rounded-lg border animate-pulse"
          >
            <span className="ml-2  md:block  bg-gray-300 h-4 w-16 rounded-lg animate-pulse"></span>
          </button>
        </form>
      </div>
